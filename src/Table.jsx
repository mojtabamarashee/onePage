                        ...
                        }
                        {
                          ...
                          (
                            <td
                              ...
                              data-sort={v.tvol}>
                              {t1} <p style={{clear: 'left', margin: '0'}} />{' '}
                              {t2}
                            </td>
                          ))
                        }
	...
	componentDidMount() {
		...
		allRows
			...
			.forEach((v, i) => {
				...
				data.push(v.ct.Buy_CountN);
				let canvas = document.getElementById('hn' + v.inscode);
				this.PlotVal('hn' + v.inscode.toString(), data, canvasMargin * canvas.height, canvas.height);
			});
...
>>>>>>> dfe38cf653ab477ccc02c2b400aed5e2c8b74510
}
